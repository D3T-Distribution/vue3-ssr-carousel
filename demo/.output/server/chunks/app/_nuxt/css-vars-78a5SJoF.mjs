...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/demos/gutters/css-vars.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const cssVars = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { cssVars as default };
//# sourceMappingURL=css-vars-78a5SJoF.mjs.map
