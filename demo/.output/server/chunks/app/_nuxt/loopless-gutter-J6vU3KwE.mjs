...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/demos/peeking/loopless-gutter.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const looplessGutter = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { looplessGutter as default };
//# sourceMappingURL=loopless-gutter-J6vU3KwE.mjs.map
