...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/demos/misc/disabling.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const disabling = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { disabling as default };
//# sourceMappingURL=disabling-8klIkpwk.mjs.map
