...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/demos/gutters/numbers.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const numbers = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { numbers as default };
//# sourceMappingURL=numbers-wrG0HjMm.mjs.map
