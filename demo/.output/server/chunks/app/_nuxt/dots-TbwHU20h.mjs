...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/demos/ui/dots.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const dots = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { dots as default };
//# sourceMappingURL=dots-TbwHU20h.mjs.map
