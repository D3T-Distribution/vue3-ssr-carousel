import { u as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-T6aUc4nE.mjs';
import { e as useState, a as useRuntimeConfig } from '../server.mjs';
import { E as hash } from '../../nitro/node-server.mjs';
import { u as useContentPreview } from './preview-ea5iqoFC.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-95CfJqPH.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-ls5P8w2X.mjs.map
