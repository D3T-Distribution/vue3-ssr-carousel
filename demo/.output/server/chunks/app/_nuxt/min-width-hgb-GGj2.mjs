...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/demos/responsive/min-width.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const minWidth = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { minWidth as default };
//# sourceMappingURL=min-width-hgb-GGj2.mjs.map
