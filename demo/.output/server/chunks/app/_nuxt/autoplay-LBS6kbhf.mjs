...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/demos/misc/autoplay.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const autoplay = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { autoplay as default };
//# sourceMappingURL=autoplay-LBS6kbhf.mjs.map
