...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/demos/accessibility/loop-disabling.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const loopDisabling = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { loopDisabling as default };
//# sourceMappingURL=loop-disabling-XSm-oOhl.mjs.map
