...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/demos/responsive/variable-width-disabled.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const variableWidthDisabled = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { variableWidthDisabled as default };
//# sourceMappingURL=variable-width-disabled-mHCnD68C.mjs.map
