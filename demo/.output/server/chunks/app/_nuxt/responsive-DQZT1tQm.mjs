...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/demos/peeking/responsive.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const responsive = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { responsive as default };
//# sourceMappingURL=responsive-DQZT1tQm.mjs.map
