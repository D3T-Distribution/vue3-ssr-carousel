...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_ssr_carousel, mergeProps({
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<!--[-->`);
        ssrRenderList(["red", "orange", "yellow", "green"], (color, index) => {
        ...
        return [
          (openBlock(), createBlock(Fragment, null, renderList(["red", "orange", "yellow", "green"], (color, index) => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/demos/peeking/cloning.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const cloning = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { cloning as default };
//# sourceMappingURL=cloning-OnMUfTFd.mjs.map
