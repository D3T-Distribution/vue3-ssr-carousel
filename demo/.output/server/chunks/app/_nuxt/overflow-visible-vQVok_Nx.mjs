...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/demos/peeking/overflow-visible.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const overflowVisible = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { overflowVisible as default };
//# sourceMappingURL=overflow-visible-vQVok_Nx.mjs.map
