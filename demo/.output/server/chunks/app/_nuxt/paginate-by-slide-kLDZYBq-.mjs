...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/demos/ui/paginate-by-slide.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const paginateBySlide = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { paginateBySlide as default };
//# sourceMappingURL=paginate-by-slide-kLDZYBq-.mjs.map
