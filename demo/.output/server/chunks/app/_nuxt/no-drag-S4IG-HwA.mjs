...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/demos/ui/no-drag.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const noDrag = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { noDrag as default };
//# sourceMappingURL=no-drag-S4IG-HwA.mjs.map
