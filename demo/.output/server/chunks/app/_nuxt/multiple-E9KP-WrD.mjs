...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/demos/looping/multiple.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const multiple = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { multiple as default };
//# sourceMappingURL=multiple-E9KP-WrD.mjs.map
